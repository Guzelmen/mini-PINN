...
def concatenate_parts(parts=None, n_parts=4, base_name="phase_4_solver_mega_fine", out_path=None):
    ...
    for part in parts:
        part_path = data_dir / f"{base_name}_part{part}.pt"
...
if __name__ == "__main__":
    ...
    concatenate_parts(parts=args.parts, n_parts=args.n_parts, base_name=args.base_name, out_path=args.out_path)
